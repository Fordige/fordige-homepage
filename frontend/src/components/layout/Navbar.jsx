...
function Navbar() {
  ...
  return (
    <nav className="bg-accent fixed top-0 flex h-24 w-screen items-center justify-start px-8 py-2">
      <div className="bg-midtone flex w-56 items-center justify-between self-stretch px-[1.426rem] py-[1.755rem]">
        <div className="text-[4.36rem] font-normal text-black">logo</div>
      </div>
      <div className="font-inter flex w-[67.75rem] items-center justify-between self-stretch px-24 text-[2rem] font-semibold text-black">
        <button>About</button>
      ...
      <div className="flex w-[34.25rem] justify-end gap-5 self-stretch">
        <div className="flex gap-2">
          <label
            htmlFor="language"
            className="font-inter w-[7.19rem] justify-start self-stretch text-right text-2xl font-semibold text-black"
          >
            Language
          </label>
          <select

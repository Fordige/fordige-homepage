...
const BackToTop = ({ scrollToSection }) => {
  return (
    <div
      className="fixed bottom-[5rem] right-[2rem] z-30 flex h-[1.88rem] w-[8.63rem] cursor-pointer items-center justify-center rounded-[1rem] bg-highlight dark:bg-shadow3"
